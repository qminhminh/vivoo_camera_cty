...
class DropdownDateMotion extends StatefulWidget {
  const DropdownDateMotion({super.key, required this.idcamera});
  final String idcamera;

  @override
  State<DropdownDateMotion> createState() => _DropdownDateMotionState();
}

class _DropdownDateMotionState extends State<DropdownDateMotion> {

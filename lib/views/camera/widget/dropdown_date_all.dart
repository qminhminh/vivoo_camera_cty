...
class DropdownDateAll extends StatefulWidget {
  const DropdownDateAll({super.key, required this.idcamera});
  final String idcamera;

  @override
  State<DropdownDateAll> createState() => _DropdownDateAllState();
}

class _DropdownDateAllState extends State<DropdownDateAll> {

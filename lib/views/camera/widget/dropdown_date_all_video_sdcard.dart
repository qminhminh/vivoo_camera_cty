...
class DropdownDateAllVideoSdcard extends StatefulWidget {
  const DropdownDateAllVideoSdcard({super.key, required this.idcamera});
  final String idcamera;

  @override
  State<DropdownDateAllVideoSdcard> createState() =>
      _DropdownDateAllVideoSdcardState();
}

class _DropdownDateAllVideoSdcardState
    extends State<DropdownDateAllVideoSdcard> {
                      ...
                      return ListTile(
                        ...
                        onTap: () {
                          setState(() {
                            ...
                            cloudRecordController.setStartTimeSdcardImage =
